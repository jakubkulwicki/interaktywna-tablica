...
io.on('connection', function(socket) {
    ...
    socket.on('adnotacja', function(adn) {
        ...
        fs.readFile('db.json', function(err, data) {
            ...
            io.emit('images', "<div style='position: absolute; left: " + 0.0 + "px; top: " + 0.0
                    + "px' class='dragg'><div class='resiz' id='" + (json['num'][0].num - 1) + "'><div class='adn'>" + adn + "</div></div></div><div style='position: absolute; left: "
                    + (- 10) + "px; top: " + (- 10) + "px' class='del' id='del" + json['num'][0].num + "'>Usuń</div>");
    ...
    uploader.on("saved", function(event) {
        ...
        fs.readFile('db.json', function(err, data) {
            ...
            json["files"].push(obj);
            io.emit('images', "<div class='dragg'><img style='position: absolute' class='resiz' id='" + json['num'][0].num + "' height='250' src='" + path2 + "' /></div><div style='position: absolute; left: " + (- 10) + "px; top: " + (- 10) + "px' class='del' id='del" + json['num'][0].num + "'>Usuń</div>");
